defmodule Workers.Application do
  ...
  def start(_type, _args) do
    import Supervisor.Spec, warn: false
     ...
     url_workers =  1..200 |> Enum.map(fn (i) -> supervisor(Workers.UrlSupervisor, [i], [id: {Workers.UrlSupervisor, i}, restart: :permanent]) end)
     domain_workers = 1..200 |> Enum.map(fn (i) -> supervisor(Workers.DomainSupervisor, [i], [id: {Workers.DomainSupervisor, i}, restart: :permanent]) end)
